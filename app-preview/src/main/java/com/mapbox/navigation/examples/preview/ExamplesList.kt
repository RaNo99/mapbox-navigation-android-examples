...
import com.mapbox.navigation.examples.preview.dropinui.NavigationViewNoSimulationActivity
...
fun Context.examplesList() = listOf(
    MapboxExample(
        ...
        getString(R.string.title_navigation_view) + " [with location simulation]",
        getString(R.string.description_navigation_view),
        NavigationViewActivity::class.java
    ),
    MapboxExample(
        ContextCompat.getDrawable(this, R.drawable.mapbox_screenshot_navigation_view),
        getString(R.string.title_navigation_view) + " [real location]",
        getString(R.string.description_navigation_view),
        NavigationViewNoSimulationActivity::class.java
    ),
//    MapboxExample(
